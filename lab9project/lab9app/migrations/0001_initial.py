        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "order_item_id",
                    models.AutoField(
                        db_column="Order_Item_ID", primary_key=True, serialize=False
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order_status",
                    models.CharField(
                        blank=True, db_column="Order_Status", max_length=11, null=True
                    ),
                ),
                (
                    "order_date",
                    models.DateTimeField(blank=True, db_column="Order_Date", null=True),
                ),
                (
                    "total_price",
                    models.DecimalField(
